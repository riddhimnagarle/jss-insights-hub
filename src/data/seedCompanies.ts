// PHASE 1: hardcoded seed data. No database, no Supabase.
// The shapes below (short_json / full_json / skill_levels) match the future
// JSONB columns exactly, so Phase 2 can pipe rows straight into the
// normalizers in src/lib/companyData.ts without touching UI code.
